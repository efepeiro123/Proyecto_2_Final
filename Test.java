...
public class Test{
    ...
    private String[] ListaPsico = {
        "\n------------------------------------------------------------------------------------\nPoseo la energía suficiente para enfrentarme a todos mis problemas\n\nA) Siempre\nB) Frecuentemente\nC) Raras veces\n\n", //A
        "\n------------------------------------------------------------------------------------\nEvito criticar a la gente y sus ideas. \n\nA) Si\nB) Algunas veces\nC) No\n\n", //B
        "\n------------------------------------------------------------------------------------\nHe pertenecido a algún equipo deportivo o similar. \n\nA) Si \nB) No \n\n", //A
        "\n------------------------------------------------------------------------------------\nCuando me propongo una meta ¿Me aseguro de cumplirlas?. \n\nA) Si \nB) No \n\n", //A
        "\n------------------------------------------------------------------------------------\nEs mejor ser cauto y esperar poco que optimista y esperar siempre el éxito. \n\nA) Afirmativo\nB) Falso \n\n", //A
        ...
        "\n------------------------------------------------------------------------------------\n¿Me gusta tomar parte activa en las tareas sociales, trabajos de comité, etc? \n\nA) Si \nB) Término medio \nC) No \n\n", // A
        "\n------------------------------------------------------------------------------------\nAl llevar a cabo una tarea, no estoy satisfecho hasta que se ha considerado con toda atención el menor detalle:  \n\nA) Si \nB) A veces \nC) No \n\n", // A
        "\n------------------------------------------------------------------------------------\nSiempre soy capaz de controlar perfectamente la expresión de mis sentimientos:  \n\nA) Si \nB) A veces\nC) No \n\n", // A
        "\n------------------------------------------------------------------------------------\nAlgunas personas parecen ignorarme o evitarme, aunque no sé por qué:  \n\nA) Verdadero \nB) No estoy seguro \nC) Falso \n\n", // C
        "\n------------------------------------------------------------------------------------\nAunque no sea en un grupo mixto de mujeres y hombres, me disgusta que se use un lenguaje obsceno.  \n\nA) Verdadero \nB) No estoy seguro \nC) Falso \n\n", // A
        "\n------------------------------------------------------------------------------------\nMe resulta fácil mezclarme con la gente en una reunión social:  \n\nA) Verdadero \nB) No estoy seguro \nC) Falso \n\n", // A
        "\n------------------------------------------------------------------------------------\nSería más interesante ser:  \n\nA) Orientador vocacional  \nB) No estoy seguro \nC) Directivo \n\n", // C
        "\n------------------------------------------------------------------------------------\nMe disgusta el modo con que algunas personas se fijan en otras en la calle o en las tiendas:  \n\nA) Si  \nB) No estoy seguro \nC) No \n\n", // A
        "\n------------------------------------------------------------------------------------\nMe niego a admitir sugerencias bien intencionadas de los demás. aunque sé que no debería hacerlo:   \n\nA) Algunas veces  \nB) Casi nunca \nC) Nunca \n\n", // C
        "\n------------------------------------------------------------------------------------\nMe considero a mí mismo como una persona muy abierta y sociable:  \n\nA) Si  \nB) Término medio \nC) No \n\n", // A
    };
